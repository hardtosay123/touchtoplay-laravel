...
@section('title')Post #{{ $post->id }} - Community - {{ config('app.name', 'Touch To Play!') }}@endsection
                ...
                <div class="row">
                    <div class="col-12 d-flex justify-content-between">
                        <div class="nav-item dropdown">
                            <a href="#" id="mypostsDropdown" class="nav-link dropdown-toggle btn{{ (Auth::check() && Auth::id() === $post->user_id) ? ' btn-primary' : ' btn-secondary' }}" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">My Posts</a>
                        ...
                        <a href="{{ url('/community') }}" class="btn{{ (Auth::check() && Auth::id() === $post->user_id) ? ' btn-secondary' : ' btn-primary' }}">Community Home</a>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex justify-content-between">
                                            <a href="{{ url("/account"."/".$post->user->id) }}" class="mb-0 font-weight-bold">{{ $post->user->name }} <span class="text-dark font-italic"><small>(user ID : {{ $post->user->id }})</small></span></a>
